    ...
    return ( 
        <div className="HeroSection text-amber-100 z-20 flex flex-col items-center justify-center">
            ...
            <div className='cta mt-11 flex justify-center items-center gap-12'>
               ...
               <Link to={"/home"}> {userData ? <Button variant="contained" className='!bg-[#AB1B9E] z-20 !rounded-xl'>Join meeting</Button> : <Button variant="contained" className='!bg-[#AB1B9E] z-20 !rounded-xl'>Get Started</Button> } </Link>
